defmodule MockHD44780 do
  ...
  @pin_map [d4: 0x10, d5: 0x20, d6: 0x40, d7: 0x80, d0: 0x01, d1: 0x02, d2: 0x04, d3: 0x08]
  ...
  defp set_bit(state = %{register_state: register_state}, :en, 1, _) do
    ...
    {stack, register_state} =
      case register_state &&& 0x0200 do
        0x200 ->
  ...
  defp set_bit(state, :d7, _, xform) do
    shifted_value =
      case state.register_state >>> 9 do
        0 -> @pin_map[:d7]
        1 -> @pin_map[:d7] >>> 4
      end
